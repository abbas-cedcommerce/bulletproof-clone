...
declare function AutoComplete({ options, value, onChange, onClick, onEnter, name, innerPreIcon, innerSufIcon, showHelp, thickness, setHiglighted, placeHolder, loading, extraClass, popoverPosition, popoverContainer, ...props }: SearchI): JSX.Element;
